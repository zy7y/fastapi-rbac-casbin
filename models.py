...
class User(AbstractBaseModel):
    ...
    roles = fields.ManyToManyField("models.Role", related_name="users", null=True, description="拥有角色")
    active_role = fields.OneToOneField("models.Role", related_name="active_user", null=True, description="当前角色")


class Role(AbstractBaseModel):
    name = fields.CharField(max_length=32, description="角色名")
    users: fields.ManyToManyRelation[User]
    menus = fields.ManyToManyField("models.Menu", related_name="roles", null=True, description="拥有菜单")
...
class Menu(AbstractBaseModel):
    ...
    type = fields.IntEnumField(MenuType, default=MenuType.DIRECTORY, description="菜单类型")
